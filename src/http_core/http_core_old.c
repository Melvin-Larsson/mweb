...
void _response_handler(void *ctx){

}

Task http_core_create_response_async(const HttpRequest *request, Buffer *buffer, ResponseCallback callback){
//     Task task = work_task(_response_handler, NULL);
}
